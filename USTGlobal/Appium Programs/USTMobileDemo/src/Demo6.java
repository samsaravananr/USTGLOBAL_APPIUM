...
public class Demo6 extends DRIVERCALL{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		myD.findElementByXPath("//android.widget.TextView[contains(@text,'dependencies')]").click();
		
		myD.findElementByXPath("//android.widget.TextView[contains(@text,'dependencies')]").click();
		
		myD.findElementByXPath("//android.widget.TextView[contains(@text,'dependencies') or @index='2']").click();
		
		myD.findElementByXPath("//android.widget.TextView[contains(@text,'dependencies') and @index='2']").click();
